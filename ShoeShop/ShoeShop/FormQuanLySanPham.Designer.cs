namespace ShoeShop
{
    partial class FormQuanLySanPham
    {
		...
		private void InitializeComponent()
		{
			...
			panelTop.Size = new Size(1304, 60);
			panelTop.TabIndex = 0;
			// 
			// lblTitle
			// 
			...
			panelSearch.Size = new Size(1260, 60);
			...
			panelInput.Size = new Size(1260, 180);
			...
			panelImage.Location = new Point(730, 10);
			...
			picPreview.Location = new Point(10, 70);
			...
			btnChonAnh.Location = new Point(370, 33);
			btnChonAnh.Name = "btnChonAnh";
			btnChonAnh.Size = new Size(120, 27);
			...
			txtImages.Location = new Point(10, 35);
			...
			txtSoLuong.Location = new Point(540, 87);
			...
			label7.Location = new Point(460, 90);
			label7.Name = "label7";
			...
			txtGia.Location = new Point(540, 52);
			txtGia.Name = "txtGia";
			txtGia.Size = new Size(150, 25);
			txtGia.TabIndex = 11;
			// 
			// label6
			// 
			...
			label6.Location = new Point(460, 55);
			label6.Name = "label6";
			...
			txtMauSac.Location = new Point(540, 17);
			txtMauSac.Name = "txtMauSac";
			txtMauSac.Size = new Size(150, 25);
			...
			label5.Location = new Point(460, 20);
			label5.Name = "label5";
			...
			txtKichCo.Location = new Point(120, 122);
			txtKichCo.Name = "txtKichCo";
			txtKichCo.Size = new Size(100, 25);
			...
			cboLoaiSP.Location = new Point(120, 87);
			cboLoaiSP.Name = "cboLoaiSP";
			cboLoaiSP.Size = new Size(200, 25);
			...
			panelButtons.Location = new Point(20, 360);
			panelButtons.Name = "panelButtons";
			panelButtons.Size = new Size(1260, 60);
			...
			btnXoa.Location = new Point(700, 10);
			btnXoa.Name = "btnXoa";
			...
			btnSua.Location = new Point(560, 10);
			btnSua.Name = "btnSua";
			...
			btnThem.Location = new Point(420, 10);
			...
			dgvSanPham.Location = new Point(20, 440);
			dgvSanPham.Name = "dgvSanPham";
			dgvSanPham.RowHeadersWidth = 62;
			dgvSanPham.RowTemplate.Height = 30;
			dgvSanPham.Size = new Size(1260, 240);
